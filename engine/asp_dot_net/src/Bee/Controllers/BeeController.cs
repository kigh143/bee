    ...
    public class BeeController : ApiController
    {
        ...
        public object Post()
        {
            ...
            try
            {
                ...
                JToken jtx = Bee.Engine.Hive[Bee.Engine.RawHiveDefiniationSecurityNodeName][Bee.Engine.RawHiveDefiniationSecurityIsRegistrationOpenNodeName];
                bool isRegistrationOpen = (Boolean)(jtx);
